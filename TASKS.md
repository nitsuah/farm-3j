...
- [x] Blacksmith building — Blacksmith (100🪙 60🌲 80🪨) enables ⚔️ Steel Edge (2 levels, +5 atk per level all units) and 🛡️ Iron Hide (2 levels, -2 dmg taken per level from grunts); stone forge SVG with chimney; AoE/Warcraft-style dedicated upgrade building (2026-07-01): sell 50🌲 for 30🪙 or 30🪨 for 20🪙 via command card buttons; AoE-style economy layer for converting surplus resources (2026-06-26) — Siege Workshop (100🪙 80🌲 60🪨) enables training 🪨 Catapults (150g/80l, 60HP); catapults auto-fire AoE splash at grunts within 6 tiles (22 direct / 11 splash, 3.5s cooldown); slow movement; distinct SVG (wooden frame, wheels, throwing arm, boulder); can't harvest or garrison (2026-06-26)
