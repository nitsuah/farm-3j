...
export const BUILDING_VISION = 2;
export const WATCHTOWER_VISION = 7;
export const ENEMY_WALL_GOLD = 15;
export const ENEMY_TOWER_GOLD = 25;
export const ENEMY_ARCHER_TOWER_GOLD = 40;
export const TOME_XP_REWARD = 80;
