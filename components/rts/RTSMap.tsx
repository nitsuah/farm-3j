      ...
      >
        ...
        >
          ...
          {enemyWarchiefs
            .filter(
              wc =>
                wc.hp > 0 && fogVisible[Math.round(wc.x)]?.[Math.round(wc.y)]
            )
            .map(wc => {
              ...
              return (
                <g pointerEvents="none">
                  ...
                  <polygon
                    points={pts}
                    fill={
                      valid ? 'rgba(74,222,128,0.35)' : 'rgba(239,68,68,0.35)'
                    }
          ...
          {placedBuildings.map(b => {
            ...
            if (b.constructing) {
              ...
              const progress = Math.min(
                1,
                (elapsed * speedMult) / CONSTRUCTION_MS
              );
              return (
                <g
                  key={`building-${b.id}`}
                  ...
                  onContextMenu={e =>
                    handleAssistConstruction(b.id, b.x, b.y, e)
                  }
                >
                  {/* Scaffold base */}
                  <rect
            ...
            if (b.type === 'wall') {
              ...
              const wallCtxMenu =
                wallIsDamaged && anySelected
                  ? (e: React.MouseEvent) =>
                      handleRepairBuilding(b.id, b.x, b.y, e)
                  : canUpgradeThisWall
                    ? (e: React.MouseEvent) => {
                        e.preventDefault();
                        e.stopPropagation();
            ...
            .map(ew => {
              ...
              return (
                <g
                  ...
                  onContextMenu={e =>
                    handleAttackEnemyWall(ew.id, ew.x, ew.y, e)
                  }
                >
                  <rect
                    x={isoX + 8}
            ...
            return (
              ...
              >
                ...
                <rect
                  ...
                  height={4}
                  fill={
                    hp > 0.5 ? '#4ade80' : hp > 0.25 ? '#fbbf24' : '#ef4444'
                  }
                />
                {worker.level > 0 && (
                  <text
