...
function ProjectileShape({ p }: { p: Projectile }) {
  ...
  if (p.type === 'ice') {
    ...
    return (
      <g
        transform={`translate(${cx},${cy}) rotate(${spin})`}
        opacity={opacity}
        pointerEvents="none"
      >
        <polygon
          points="0,-6 2,-1 0,6 -2,-1"
          fill="#bfdbfe"
          stroke="#60a5fa"
          strokeWidth={0.8}
        />
        <polygon
          points="-6,0 -1,-2 6,0 -1,2"
          fill="#93c5fd"
          stroke="#60a5fa"
          strokeWidth={0.8}
        />
  ...
  ({
    ...
    return (
      <>
        ...
        {darkPath && (
          <path d={darkPath} fill="rgba(0,0,0,0.88)" pointerEvents="none" />
        )}
        {dimPath && (
          <path d={dimPath} fill="rgba(0,0,0,0.45)" pointerEvents="none" />
        )}
